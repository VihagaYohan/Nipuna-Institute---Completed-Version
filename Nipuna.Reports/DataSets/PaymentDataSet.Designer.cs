...
namespace Nipuna.Reports.DataSets.PaymentDataSetTableAdapters {
...
SELECT Id, InvoiceNo, RegistrationId, StudentName, CourseId, CourseName, LecturerId, LectuerName, Fee, Amount, Balance, PaidDate, Invoicedate, Username, IsRemoved FROM Payments WHERE (Id = @Id)";
        ...
        public virtual int Fill(PaymentDataSet.PaymentsDataTable dataTable) {
        ...
        public virtual PaymentDataSet.PaymentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PaymentDataSet.PaymentsDataTable dataTable = new PaymentDataSet.PaymentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PaymentDataSet.PaymentsDataTable dataTable) {
