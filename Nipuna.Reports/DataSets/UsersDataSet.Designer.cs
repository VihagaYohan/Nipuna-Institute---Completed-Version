...
namespace Nipuna.Reports.DataSets {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string UserName, string SurName, string FirstName, string LastName, string Nic, string ContactNo, string Role, System.DateTime DateCreated, bool IsRemoved) {
...
namespace Nipuna.Reports.DataSets.UsersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Users] WHERE (([Id] = @Original_Id) AND ([DateCreated] = @Original_D" +
                "ateCreated) AND ([IsRemoved] = @Original_IsRemoved))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Users] ([UserName], [SurName], [FirstName], [LastName], [Nic], [ContactNo], [Role], [DateCreated], [IsRemoved]) VALUES (@UserName, @SurName, @FirstName, @LastName, @Nic, @ContactNo, @Role, @DateCreated, @IsRemoved);
SELECT Id, UserName, SurName, FirstName, LastName, Nic, ContactNo, Role, DateCreated, IsRemoved FROM Users WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [UserName] = @UserName, [SurName] = @SurName, [FirstName] = @FirstName, [LastName] = @LastName, [Nic] = @Nic, [ContactNo] = @ContactNo, [Role] = @Role, [DateCreated] = @DateCreated, [IsRemoved] = @IsRemoved WHERE (([Id] = @Original_Id) AND ([DateCreated] = @Original_DateCreated) AND ([IsRemoved] = @Original_IsRemoved));
SELECT Id, UserName, SurName, FirstName, LastName, Nic, ContactNo, Role, DateCreated, IsRemoved FROM Users WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, UserName, SurName, FirstName, LastName, Nic, ContactNo, Role, D" +
                "ateCreated, IsRemoved\r\nFROM            Users";
        ...
        public virtual int Delete(int Original_Id, System.DateTime Original_DateCreated, bool Original_IsRemoved) {
        ...
        public virtual int Insert(string UserName, string SurName, string FirstName, string LastName, string Nic, string ContactNo, string Role, System.DateTime DateCreated, bool IsRemoved) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string SurName, string FirstName, string LastName, string Nic, string ContactNo, string Role, System.DateTime DateCreated, bool IsRemoved, int Original_Id, System.DateTime Original_DateCreated, bool Original_IsRemoved, int Id) {
            if ((UserName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string SurName, string FirstName, string LastName, string Nic, string ContactNo, string Role, System.DateTime DateCreated, bool IsRemoved, int Original_Id, System.DateTime Original_DateCreated, bool Original_IsRemoved) {
            return this.Update(UserName, SurName, FirstName, LastName, Nic, ContactNo, Role, DateCreated, IsRemoved, Original_Id, Original_DateCreated, Original_IsRemoved, Original_Id);
        }
    }
